...
with DAG(
    dag_id='staging_reviews_play_store',
    ...
    sensor_play_store_task = ExternalTaskSensor(
        task_id='sensor_fetch_raw_play_store',
        external_dag_id='fetch_reviews_play_store',
    ...
    start_task >> sensor_play_store_task
    ...
    for app in apps:
        ...
        sensor_play_store_task >> staging_play_store_task >> wait_task
