...
with DAG(
	dag_id='datamart_app_update_release',
	schedule_interval='0 2 * * *',
	default_args=default_args) as dag:

	start_task = DummyOperator(
		task_id='start_datamart_app_update_release'
	)
	...
	sql_app_update_release = """#standardSQL
	SELECT
        wad.app_id,
        wad.alt_app_id,
        wad.version,
	...
	datamart_app_update_release = BigQueryOperator(
        task_id='datamart_app_update_release',
        sql=sql_app_update_release,
        destination_dataset_table='sapporo_mart.app_update_release',
	...
	finish_task = DummyOperator(
		task_id='finish_datamart_app_update_release'
	)

	sensor_warehouse_app_info_fact >> datamart_app_update_release >> finish_task